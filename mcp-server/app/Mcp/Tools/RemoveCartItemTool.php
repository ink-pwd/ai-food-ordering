...
#[Title('Удалить строку из корзины')]
#[Description('Деструктивная операция записи: безвозвратно удаляет одну строку из текущей активной корзины. item_id — локальный CartItem.id из ответа корзины, а не product_id. Требует непрозрачный session_handle, переданный без изменений. Инструмент не выполняет других неявных изменений; обновлённые суммы возвращает бэкенд.')]
#[IsReadOnly(false)]
#[IsDestructive]
#[IsIdempotent]
#[IsOpenWorld]
final class RemoveCartItemTool extends Tool
{
