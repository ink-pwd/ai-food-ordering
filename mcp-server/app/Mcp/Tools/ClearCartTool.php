...
#[Description('Деструктивная операция записи: безвозвратно удаляет все строки из текущей активной корзины. Требует только непрозрачный session_handle, переданный без изменений. Не передавайте item_id или данные товаров. Пустая корзина допустима; итоговое состояние и суммы возвращает и рассчитывает только бэкенд.')]
#[IsReadOnly(false)]
#[IsDestructive]
#[IsIdempotent]
#[IsOpenWorld]
